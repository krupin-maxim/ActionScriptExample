package resources {
import ui.base.SimpleFillSkin;
import ui.base.SimpleSlice9Skin;
...
public class Skins {
    ...
    public static var silverNormal:SimpleSlice9Skin = new SimpleSlice9Skin(Images.getBitmapData(Images.silver_hover_png), 25, 22);
